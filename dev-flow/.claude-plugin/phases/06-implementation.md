...
**Navigation (multi-page projects):**
- Implement nav components and layouts to match navigation-spec.md
- Verify routes match the sitemap URL paths
- Nav state composable must be auth-aware per navigation-spec.md
...
- [ ] Nav components and layouts match navigation-spec.md (if multi-page)
